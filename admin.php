...
<body>
	...
	<div id="num_carte" style="float: right;">ADMINISTRATEUR : Carte <?php echo $sCode ?> :
		<?php
	...
	<div id="blocMilieu">
		<ul id="barre_onglets">
			...
			<li class="barre"><i class="fas fa-key"></i><br /><?php mkA("reserve.php","Réservations") ?></li>
      		<li class="barre"><i class="fas fa-users"></i><br /><?php mkA("utilisateurs.php","Utilisateurs") ?></li>
