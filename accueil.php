...
<body>
	...
	<div id="num_carte" style="float: right;">Carte <?php echo $sCode ?> :
		<?php
			...
			echo "<span style='text-transform: uppercase'>".$leNom[0]."</span>";
		?>
	</div>
	<?php mkBr(2) ?>
	<div id="blocMilieu">
		<ul id="barre_onglets">
			...
			<li class="barre"><i class="fas fa-key"></i><br /><?php mkA("reserve.php","Réservations") ?></li>
      		<li class="barre"><i class="fas fa-sign-out-alt"></i><br /><?php mkA("connexion.php","Déconnexion","","deleteCookie()")?></li>
		</ul><?php mkBr(2) ?>

		<h1>Bienvenue au TC Courrières !</h1><br />

		<h2 class="soustitre"><i>Nos installations</i></h2>
		...
		<div id="motPres">
			...
			<ul>
				...
				<li class="descriptifs"><b>De nombreuses équipes jeunes et adultes</b></li>
				<li class="descriptifs"><b>Un tournoi Open et jeune en Décembre - Janvier</b></li>	
				<li class="descriptifs"><b>Réservation en ligne des courts pour une accessibilité totale</b></li>
			</ul>
